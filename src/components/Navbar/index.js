    ...
    return (
        <Nav>
            <Anchorlink class="anchor-link" data-aos="fade-down" data-aos-duration="3000" data-aos-delay="20" href="#Hero">
                <h1 class="underline-hover">Diether Tolentino</h1>
            </Anchorlink>
            <NavMenu>
            ...
            <div class="relative soc-med">
                <a href='https://www.instagram.com/istdeedeets' target="_blank" onclick="window.open('https://instagram.com/istdeedeets', '_self');">
                ...
                <a href='https://www.linkedin.com/in/diether-tolentino-3ba123167/' target="_blank">
