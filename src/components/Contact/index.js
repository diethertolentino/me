      ...
      <ContactContainer>
        <ContactWrapper>
          ...
          <ContactCard>
            ...
            <ContactIcon>
              <a class="icon-link" href="https://www.instagram.com/istdeedeets" target="_blank" onclick="window.open('https://www.instagram.com/istdeedeets', '_self');">
              ...
              <a class="icon-link" href="https://www.twitter.com/deedeets024" target="_blank" onclick="window.open('https://www.twitter.com/deedeets024', '_self');">
